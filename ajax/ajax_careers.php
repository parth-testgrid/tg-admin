...
if (is_array($_FILES) && isset($_POST["fname"])) {
  $uuid = guidv4();
  ...
  if (!empty($resume) && !empty($cover_letter) && !$error) {
    $insertQuery = "INSERT INTO careers (fname, lname, email, linkedin, resume, cover_letter) VALUES ('$fname', '$lname', '$email', '$linkedin', '$uniqueResumeName', '$uniqueCoverLetterName')";
